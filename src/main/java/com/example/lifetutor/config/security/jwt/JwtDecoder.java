...
import static com.example.lifetutor.config.security.jwt.JwtTokenUtils.*;
...
public class JwtDecoder {
    ...
    public String decodeUserToken(String accessToken) {
        DecodedJWT decodedJWT = isValidToken(accessToken)
                .orElseThrow(()-> new ResponseStatusException(HttpStatus.UNAUTHORIZED, "유효한 토큰이 아닙니다.")); //유효한 토큰 아니다 해줘야함.
